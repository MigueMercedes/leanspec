...
> Scaffolded by [`claude-sdd`](https://github.com/MigueMercedes/claude-sdd). Customize the placeholders below for your project, then invoke the `sdd` skill in Claude Code to refine.
