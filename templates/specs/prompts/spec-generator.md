...
5. `specs/templates/feature.spec.md` — base sections (universal). If your project enabled extensions during `claude-sdd init`, they're already merged here. If not, see `specs/templates/extensions/README.md` for opt-in add-ons.
