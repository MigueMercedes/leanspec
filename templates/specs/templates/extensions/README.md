...
During `claude-sdd init`, select the extensions that apply to your project:
...
1. Re-run `claude-sdd init --skill-only --extensions <new-set>` (will re-prompt to overwrite `feature.spec.md`)
